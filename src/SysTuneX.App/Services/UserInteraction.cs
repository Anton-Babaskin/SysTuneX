...
public sealed class UserInteraction : IUserInteraction
{
    ...
    public Task<bool> ConfirmProfileAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        // What the dialog says is decided in Core and what it looks like is in ProfilePreviewDialog.
        // Neither used to be true: this was ninety lines of layout built control by control, here,
        // in the class that shows toasts.
        var content = new ProfilePreviewDialog(new ProfilePreviewViewModel(preview, _localization));
